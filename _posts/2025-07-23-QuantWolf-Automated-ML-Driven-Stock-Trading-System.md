...
<style>
/* Only target paragraphs immediately under the Introduction section */
.post-content .justified-intro p {
  text-align: justify !important;
  text-justify: inter-word;
  hyphens: auto;
  line-height: 1.6; /* Keep same line spacing */
}

/* Ensure headings stay exactly as they are */
.post-content h1,
.post-content h2, 
.post-content h3,
.post-content h4,
